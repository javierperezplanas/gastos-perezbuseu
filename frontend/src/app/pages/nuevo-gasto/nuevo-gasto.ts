...
implements OnInit {
  ...
  /*
   * Busca si ya existe un gasto
   * anterior con la misma descripción.
   *
   * Si existe, selecciona
   * automáticamente su categoría.
   */
  buscarCategoriaAnterior(): void {


    /*
     * No hacemos autocompletado
    ...
    .subscribe({
      ...
      error: (
        ...
        /*
         * Si no existe una categoría
         * anterior, no hacemos nada.
         */
        console.log(
          'No existe una categoría '
          +
          'anterior para esta descripción.'
        );
